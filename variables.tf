...
variable  spoke1_vm_name {
  description = "Name to add to all Virtual Machine added in spoke1's resource group"
}
...
variable  spoke2_vm_name {
  description = "Name to add to all Virtual Machine added in spoke2's resource group"
}
...
#####################spoke 3
variable spoke3_prefix {
  description = "Prefix to add to all resources added in spoke3's resource group"
}

variable  spoke3_vm_name {
  description = "Name to add to all Virtual Machine added in spoke3's resource group"
}

variable spoke3_vm_count {
}

variable spoke3_vnet_cidr {
}

variable spoke3_subnet_cidrs {
  type = list(string)
}
